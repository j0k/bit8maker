...
- Zig+raylib port: export from the GUI — WAV and MID buttons write a file (bit8maker.wav / bit8maker.mid) honoring sections, repeats and baked Game-of-Life evolution
- MP3/FLAC would need the LAME/FLAC C libraries — later

## 0.1.16 — [`a51c76f`](https://github.com/j0k/bit8maker/commit/a51c76f)
