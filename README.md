...
- **Rec button** ⏺ — capture the live output in real time (your edits, Game-of-Life evolution, pauses and all); on stop it encodes to the chosen format (WAV/MP3/FLAC) and downloads `<name>-rec`
